					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<?= Html::img("@web/images/products/" . $product->img, ['alt' => "Yii2 Shop | " . $product->name, 'title' => $product->category->name . " | " . $product->name ]); ?>
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Brand:</b> <a href="<?php echo Url::to(['category/view', 'id' => $product->category->id]); ?>"><?= $product->category->name;  ?></a></p>
